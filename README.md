...
[![Tests](https://img.shields.io/badge/tests-115%20passed-brightgreen?style=for-the-badge)](#test--verify)
...
v0.1.0 — feature-complete (backend, page, ticker, hardening, search, favicons, grouping) with an independent QA-gated history. 115-test suite + ESM render smoke. Built as a standalone unified plugin against the Hermes Desktop plugin SDK (catalog submission pending).
